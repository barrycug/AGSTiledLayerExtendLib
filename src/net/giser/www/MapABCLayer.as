package net.giser.www
{
	...
	public class MapABCLayer extends TiledMapServiceLayer
	{
		public function MapABCLayer()
		{
			super();       
	...
	private var _subDomains:Array = ["emap0","emap1","emap2","emap3"];
  ...
  //	http://emap3.mapabc.com/mapabc/maptile?v=w2.61&x=1686&y=777&z=11
	var subdomain:String = _subDomains[(level + col + row) % _subDomains.length];
     var _baseURL:String="http://"+subdomain+".mapabc.com/mapabc/maptile?v=w2.61&x=";     
     var url:String=_baseURL  +col.toString() + "&y=" + row.toString() + "&z="+level.toString();
