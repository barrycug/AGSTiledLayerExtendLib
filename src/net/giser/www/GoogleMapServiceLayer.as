package net.giser.www
{
	...
	public class GoogleMapServiceLayer extends TiledMapServiceLayer
	{
		public function GoogleMapServiceLayer()
		{
			super();       
	...
	private var _subDomains:Array = ["mt1","mt2","mt3"];
  ...
  override protected function getTileURL(level:Number, row:Number, col:Number):URLRequest
  {
     ...
     var _baseURL:String="http://"+subdomain+".google.cn/vt/v=w2.116&hl=en&gl=cn&x=";     
